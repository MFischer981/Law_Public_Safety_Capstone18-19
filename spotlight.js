// When the DOM loads set a constant of the spotlight class.
window.addEventListener("DOMContentLoaded", () => {

    const spotlight = document.querySelector('.spotlight');

    // Set spotlightSize using CSS linear gradient.
    let spotlightSize = 'transparent 120px, rgba(0, 0, 0, 0.75) 160px)';

    // On mouse move run updateSpotlight function.
    window.addEventListener('mousemove', e => updateSpotlight(e));

    // On mouse set spotlightSize value. Update spotlight.
    ...
    // Set updated radial gradient value based on mouse position.
...
// On click set element with id to display of none.
